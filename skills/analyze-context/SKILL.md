...
| a recorded LIMITATION or capability blocker — *"X cannot be done on this machine"* | **the tool itself: spend one call attempting X** before carrying the blocker forward or planning around it |
...
**Production:** <the DEPLOY PARITY line, verbatim — only when the project declares one>
```
