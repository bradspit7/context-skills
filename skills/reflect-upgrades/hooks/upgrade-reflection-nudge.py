...
def main():
    ...
    msg = (
        ...
        "real candidates. Matching, routing and filing are reflect-upgrades' Steps 3-4 - "
        "follow the skill, which is the single source for them; this hook deliberately does "
        "not carry a second copy of that rule. Nothing tool-worthy is a fine answer - and record whichever "
