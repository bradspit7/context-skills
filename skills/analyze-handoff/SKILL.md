...
- User just switched machines — cross-machine handoff needs the full memory + rules set AND `analyze-context`'s currency gate (branch survey) to catch wrong-branch staleness on branches this machine never checked out
